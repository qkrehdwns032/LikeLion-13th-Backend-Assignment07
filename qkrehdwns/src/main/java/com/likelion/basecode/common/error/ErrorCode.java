...
public enum ErrorCode {
    ...
    KOREA_API_NO_RESULT(HttpStatus.NOT_FOUND, "해당 키워드로 검색된 도서가 없습니다.", "KOREA_API_NO_RESULT_400"),

    // 500
    INTERNAL_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "내부 서버 에러가 발생했습니다", "INTERNAL_SERVER_ERROR_500"),
    KOREA_API_RESPONSE_NULL(HttpStatus.INTERNAL_SERVER_ERROR, "도서 API 응답이 null입니다.", "KOREA_API_500"),
    KOREA_API_BODY_MALFORMED(HttpStatus.INTERNAL_SERVER_ERROR, "도서 API의 body 항목이 잘못되었습니다.", "KOREA_API_500"),
    KOREA_API_ITEMS_MALFORMED(HttpStatus.INTERNAL_SERVER_ERROR, "도서 API의 items 항목이 잘못되었습니다.", "KOREA_API_500"),
    KOREA_API_ITEM_MALFORMED(HttpStatus.INTERNAL_SERVER_ERROR, "도서 API의 item 항목이 잘못되었습니다.", "KOREA_API_500"),
